...
function StartClassifying()
{
    ...
    classifier = ml5.soundClassifier("https://teachablemachine.withgoogle.com/models/bi-jjV_v8/model.json", modelLoaded);
}
...
function modelLoaded()
    ...
    function gotResult(error,results)
    {
        ...
        else
        {
            ...
            else if(results[0].label == "Tapping Desk")
            {
                img1.src = "aliens-01.png";
                img2.src = "aliens-02.png";
...
https://teachablemachine.withgoogle.com/models/bi-jjV_v8/